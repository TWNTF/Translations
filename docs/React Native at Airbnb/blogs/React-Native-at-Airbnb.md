...
[第二部分](), 我们列举了技术方面上 React Native 优点和缺陷.

[第三部分](), 我们列举了在构建跨平台移动端团队中的组织方面的问题

[第四部分](), 我们重点展示了我们对 React Native 的看法以及 Airbnb 未来的发展方向.

[第五部分](), 利用我们在 React Native 上积累的经验,使原生变得更好.
